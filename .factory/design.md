...
The 1200 × 630 social preview is a center crop of that original generated source, not a second-generation asset. The 180 px Apple touch icon is resized from the hand-authored product icon. Legal, demo, offline, and not-found routes reuse the same paper, ink, tape, and registration-label grammar.
