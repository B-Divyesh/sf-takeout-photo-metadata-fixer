# Drag-in Google Photos Takeout repair (JSON sidecar → EXIF, dedupe, rename) (`takeout-photo-metadata-fixer`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://takeout-photo-metadata-fixer.sociobot.in`. Artifact class: `pwa-offline`.
