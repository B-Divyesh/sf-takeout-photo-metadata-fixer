...
const metadata: Record<Route, { title: string; description: string; canonical: string }> = {
  home: { title: 'Takeout Tidy — repair Google Photos dates', description: 'Fix dates and locations saved in Google JSON files. Remove exact copies and rename photos without uploading them.', canonical: '/' },
